...
- `https://validator.w3.org/nu/?doc=https%3A%2F%2FSanZangana.github.io%2Finvictabyzangana%2Findex.html`

Sample HTML code validation documentation (tables are extremely helpful!):

| Page | W3C URL | Screenshot | Notes |
| --- | --- | --- | --- |
| Home | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FSanZangana.github.io%2Finvictabyzangana%2Findex.html) | ![screenshot](documentation/html-validation-home.png) | Section lacks header h2-h6 warning |
| Contact | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FSanZangana.github.io%2Finvictabyzangana%2Fcontact.html) | ![screenshot](documentation/html-validation-contact.png) | obsolete iframe warnings |
| Quiz | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FSanZangana.github.io%2Finvictabyzangana%2Fquiz.html) | ![screenshot](documentation/html-validation-quiz.png) | Pass: No Errors |
...
- `https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2FSanZangana.github.io%2Finvictabyzangana`
...
| --- | --- | --- | --- |
| style.css | [Jigsaw](https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2FSanZangana.github.io%2Finvictabyzangana) | ![screenshot](documentation/css-validation-style.png) | Pass: No Errors |
...
- As an API, using the "raw" URL appended to the linter URL.
    ...
    | --- | --- | --- | --- |
    | PP3 *run.py* file | `https://pep8ci.herokuapp.com/` | `https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/run.py` | `https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/run.py` |
    | Boutique Ado *settings.py* | `https://pep8ci.herokuapp.com/` | `https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/boutique_ado/settings.py` | `https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/boutique_ado/settings.py` |
...
| --- | --- | --- | --- |
| run.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/run.py) | ![screenshot](documentation/py-validation-run.png) | W291 trailing whitespace |
| settings.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/boutique-ado/settings.py) | ![screenshot](documentation/py-validation-settings.png) | E501 line too long |
| Blog views.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/blog/views.py) | ![screenshot](documentation/py-validation-blog-views.png) | Pass: No Errors |
| Checkout urls.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/checkout/urls.py) | ![screenshot](documentation/py-validation-checkout-urls.png) | W292 no newline at end of file |
| Profiles models.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/SanZangana/invictabyzangana/main/profiles/models.py) | ![screenshot](documentation/py-validation-profiles-models.png) | Pass: No Errors |
...
Due to time constraints, i decided to remove the 'todo' app. However, I did write several tests in this app before removing it. 
[Click here](https://github.com/SanZangana/InvictaByZangana/commit/6c664ef26254d1c0e92143a393e6cfd7834d544b) to view the historical commit where my various tests are.
...
Please note, I removed the 'coverage' since this app has since been deleted
...
Alternatively, use this link: https://github.com/SanZangana/InvictaByZangana/issues
...
All previously closed/fixed bugs can be tracked [here](https://github.com/SanZangana/InvictaByZangana/issues?q=is%3Aissue+is%3Aclosed).

| Bug | Status |
| --- | --- |
| [JS Uncaught ReferenceError: `foobar` is undefined/not defined](https://github.com/SanZangana/InvictaByZangana/issues/1) | Closed |
| [Python `'ModuleNotFoundError'` when trying to import module from imported package](https://github.com/SanZangana/InvictaByZangana/issues/2) | Closed |
| [Django `TemplateDoesNotExist` at /appname/path appname/template_name.html](https://github.com/SanZangana/InvictaByZangana/issues/3) | Closed |

**Open Issues**

Any remaining open issues can be tracked [here](https://github.com/SanZangana/InvictaByZangana/issues).

| Bug | Status |
| --- | --- |
| [JS `'let'` or `'const'` or `'template literal syntax'` or `'arrow function syntax (=>)'` is available in ES6 (use `'esversion: 11'`) or Mozilla JS extensions (use moz).](https://github.com/SanZangana/InvictaByZangana/issues/4) | Open |
| [Python `E501 line too long` (93 > 79 characters)](https://github.com/SanZangana/InvictaByZangana/issues/5) | Open |
